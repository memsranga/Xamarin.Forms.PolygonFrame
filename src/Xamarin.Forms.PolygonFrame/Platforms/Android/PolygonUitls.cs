...
{
    internal static class PolygonUitls
    {
        internal static Path RegularPolygonPath(double rectWidth, double rectHeight, int sides, double cornerRadius = 0.0, double lineWidth = 0.0, double rotationOffset = 0.0)
        {
